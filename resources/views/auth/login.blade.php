          ...
          @endif
                ...
                <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
                    <div class="px-5 py-7">
                        ...
                        <div>
                            ...
                            <input type="password" name="confirm_password" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
                        </div>
                        <button type="submit"
            ...
            <div class="py-5">
                <div class="grid grid-cols-2 gap-1">
                    <div class="text-center sm:text-left whitespace-nowrap">
                        <button
                            class="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-200 focus:outline-none focus:bg-gray-300 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset" onclick="location.href='register'"">
